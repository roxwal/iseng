;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'GA BOHONG KOK', 'PENCET LAGI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO ', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG', 'YASUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'TIDAK TAU UNTUK SIAPA ?', 'BYE', 'MAAFIN YA', 'KALO AKU BIKIN KAMU SEDIKIT KESAL']
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Event listener untuk tombol kontrol audio
  audioControl.addEventListener('click', () => {
    if (isPlaying) {
      audio.pause();
      audioControl.textContent = '🔇'; // Ubah ikon tombol ke "Mute"
    } else {
      audio.play();
      audioControl.textContent = '🔊'; // Ubah ikon tombol ke "Sound On"
    }
